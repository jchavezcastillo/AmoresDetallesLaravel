	...
	<div class="container">
		...
		<div class="col-xs-12 col-sm-12 col-md-2 col-md-lg-2">
			<ul class="padding-bottom-2 menu-view">
				...
				<a href="{!! route('admin.nina') !!}/#menu-ancla">
					<li>
				...
				<a href="{!! route('admin.nino') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Niño
						</div>
				...
				<a href="{!! route('admin.ella') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Ella
						</div>
				...
				<a href="{!! route('admin.el') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Él
						</div>
				...
				<li><br></li>
				<a href="{!! route('admin.hogar') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Hogar
						</div>
				...
				<a href="{!! route('admin.oficina') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Oficina
						</div>
				...
				<a href="{!! route('admin.escuela') !!}/#menu-ancla">
					<li>
						<div class="input-group">
						  &#8226;Escuela
						</div>
				...
				<a href="{!! route('admin.galeria') !!}/#menu-ancla">
					<li class="subrayar">
						<div class="input-group">
						  &#8226;Galería
						</div>
